...
//       setErr(null);
//       try {
//         // First try: as specified → POST with { range: { startDate, endDate } }
...
//         });
//       } catch (eA: any) {
//         // Optional fallback: some stacks use flat body keys
...
export default function CouponsReportsPage() {
  ...
  function handleExcelDownload(excelBase64: string, excelFileName: string) {
    ...
    try {
      ...
      setTimeout(() => setDownloading(false), 800); // UI feedback for button tap
    }
  }
