...
// // import Navbar, { DateRangeKey } from '@/components/Navbar';
...
// //   const list: ServiceWiseItem[] = Array.isArray(p?.serviceWise)
// //     ? p.serviceWise.map((it: any) => ({
...
// //   /* ---------- Upper + Lower (Departments/Radial) state ---------- */
...
// //       setServicesErr(null);
// //       try {
// //         // Preferred: POST with nested range
// //         const res = await apiCall(
// //           'POST',
...
// //   const fmtCount = (v: number | null) => (v == null ? '—' : nf.format(v));
...
// //       {/* Top navbar controls the main (dashboard) date range */}
// //       <Navbar
// //         active={true}
// //         selectedRange={range}
// //         onFilterChange={(r) => setRange(r as DateRangeKey)}
// //       />

// //       <div className="flex-1 pt-24 pb-4 px-4 lg:px-6 w-full container">
// //         {/* UPPER: Line Chart + KPI cards */}
...
// //                     {kpiData
// //                       ? `${kpiData[key as keyof BookingKPI]?.pctVsPrevMonth}%`
// //                       : '--'}
// //                   </div>
// //                 </div>
...
// //                     {kpiData
// //                       ? (kpiData[key as keyof BookingKPI] as any)?.count
// //                       : '--'}
// //                   </h1>
...
// //         {/* LOWER A: Departments Table + Radial Chart */}
...
// //               <div>
// //                 <div className="px-4 py-1 text-sm text-white rounded-lg bg-coffee">
// //                   Departments
// //                 </div>
// //               </div>
// //               <div>
// //                 <div className="px-4 py-1 text-sm text-white rounded-lg bg-success">
// //                   Order Received
// //                 </div>
// //               </div>
// //               <div>
// //                 <div className="px-4 py-1 text-sm text-white rounded-lg bg-primary2">
// //                   Order Picked
// //                 </div>
// //               </div>
// //             </div>
...
// //               {!dashLoading &&
// //                 !dashError &&
// //                 Object.entries(serviceStatusData).map(([key, value]) => (
// //                   <div key={key}>
...
// //             {serviceRevenue && (
// //               <RadialChartStacked revenueData={serviceRevenue} />
// //             )}
// //           </div> */}
// //         {/* </div> */}

// //         {/* LOWER B: Services Report (Single Matrix Table, with date calendar) */}
// //         <div className="mt-8">
...
// //                   // Header chip colors (for service names)
// //                   const chipColors = [
// //                     'bg-coffee',
// //                     'bg-success',
// //                     'bg-primary2',
...
// //                   ) => {
// //                     if (val == null) return '—';
// //                     if (kind === 'count') return fmtCount(Number(val));
// //                     if (kind === 'amount') return fmtAmt(Number(val));
// //                     return fmtRating(Number(val));
// //                   };

// //                   // Text-only colors (no background tint)
...
//   return (
//     <div className="min-h-screen flex flex-col w-full">
//       {/* Top navbar (now WITHOUT filter) */}
//       <Navbar active className="" />

//       <div className="flex-1 pt-24 pb-4 px-4 lg:px-6 w-full container">
//         {/* DASHBOARD RANGE FILTER moved here */}
//         <div className="mb-4 flex items-center justify-between gap-3">
...
/** ✅ Normalizes both legacy `serviceWise` and current `complaintTypeWise` */
function normalizeServicesPayload(p: any): ServicesReportRes {
  const s = p?.stats ?? {};
  const stats: ServicesStats = {
    totalServices: Number(s.totalServices ?? 0),
