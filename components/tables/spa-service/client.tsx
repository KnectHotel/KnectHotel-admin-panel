...
//   // debounce + stale-response guards
...
//       // always send page & limit; add searchTerm only if searching
...
//         // ✅ server-driven pagination (prefer API totals)
//         const srvTotal =
...
//         // optional: sync client page if server returns it
...
//         <Button onClick={() => setIsManageProductsModalOpen(true)} className="btn-primary h-8 2xl:h-9">
//           Manage Products
//         </Button>
//         <ManageProductsModal
...
export const SpaServiceDataTable: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* ✅ Buttons row: Manage Products + Manage Slots */}
